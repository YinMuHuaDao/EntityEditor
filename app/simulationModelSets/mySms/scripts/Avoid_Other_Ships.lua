...
-- Ship parameters:
local mySize, myBVOffset = this:getBoundingVolume()
local myWidth = mySize:getRight()
local myMoveSystem = this:getSystem("movement")
local myNavClass = getNavClass(this)

-- Computed each tick, used globally:
local myTurnRadius = 1.0 --Just a default init
local myOrderedSpeed = 1.0
...
function tick()
   printDebug("Tick: ", vrf:getSimulationTime())
