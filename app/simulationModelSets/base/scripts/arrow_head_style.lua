...
--  setParameters.arrowStyle Type: Integer (0 - choice limit)
--  setParameters.arrowPlacement Type: Integer (0 - choice limit)
--  setParameters.arrowWidth Type: Integer
...
function tick()
   local arrowPlacement = setParameters.arrowPlacement
   if (arrowPlacement == 2) then
      arrowPlacement = 3
   elseif (arrowPlacement == 3) then
      arrowPlacement = 5
   end
   vrf:sendSetData(this, "set-formatting-data",
      {arrow_style=setParameters.arrowStyle,
        arrow_size=setParameters.arrowWidth,
        arrow_frequency=arrowPlacement})
