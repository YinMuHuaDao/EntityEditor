...
function startSubtask()
	...
	mySubtaskId = vrf:startSubtask("AircraftHold", {fixPoint = myFixLocation,
		...
		direction = taskParameters.direction,pattern_type = taskParameters.pattern_type,timeValue = taskParameters.time,length = taskParameters.length, width = taskParameters.width  })
end
